...
conn = mysql.connector.connect(
    ...
    password="Parvez@12",     # your MySQL password
    database="course_management"
)

cursor = conn.cursor()

# List to store courses (currently unused)
courses = []
...
def add_course():
    ...
    # Include 'fees' in the SQL statement
...
def update_course():
    ...
    if course:
        ...
        # Update SQL now includes the 'fees' field as well
...
# Corrected __name__ condition for script execution
